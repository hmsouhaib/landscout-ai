...
| `src/landscout/stages/enrich_planning_zoning.py` | Intersects parcels with source-completely verified GPU zoning polygons and retains factual overlap evidence. | [files/src/landscout/stages/enrich_planning_zoning.py.md](files/src/landscout/stages/enrich_planning_zoning.py.md) |
...
| `tests/unit/test_package.py` | Provides complete unit and regression coverage for the `package` contracts exercised in this file. | [files/tests/unit/test_package.py.md](files/tests/unit/test_package.py.md) |
