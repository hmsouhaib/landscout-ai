...
| Repository file | Actual role | Companion |
|---|---|---|
| `src/landscout/sources/__init__.py` | Re-exports approved source-bound adapter APIs, including Cadastre authority and INPN extraction/catalog/attribute/geometry-profile/evidence-bundle trust boundaries, without presenting raw-path helpers as equivalent trust roots. | [files/src/landscout/sources/__init__.py.md](files/src/landscout/sources/__init__.py.md) |
...
| `src/landscout/sources/inpn_protected_areas_attributes_fr.py` | Builds and independently validates the schema-1 complete non-geometry INPN EP attribute-value profile from verified package bytes. | [files/src/landscout/sources/inpn_protected_areas_attributes_fr.py.md](files/src/landscout/sources/inpn_protected_areas_attributes_fr.py.md) |
| `src/landscout/sources/inpn_protected_areas_evidence_fr.py` | Assembles and independently validates the immutable source-bound EP evidence bundle through both public physical profile validators and complete catalog-ordered package/layer/FID alignment. | [files/src/landscout/sources/inpn_protected_areas_evidence_fr.py.md](files/src/landscout/sources/inpn_protected_areas_evidence_fr.py.md) |
...
| `src/landscout/sources/inpn_protected_areas_geometry_fr.py` | Builds and independently validates the schema-1 INPN EP geometry-quality profile from immutable SQLite snapshots and raw GeoPackage geometry BLOBs, retaining M/ZM and separate raw/parser hashes. | [files/src/landscout/sources/inpn_protected_areas_geometry_fr.py.md](files/src/landscout/sources/inpn_protected_areas_geometry_fr.py.md) |
...
| `tests/unit/test_inpn_protected_areas_attributes_fr.py` | Proves source-complete attribute-only reads, FID/scalar/domain/hash canonicalization, geometry exclusion, TOCTOU resistance, and independent profile rebuild. | [files/tests/unit/test_inpn_protected_areas_attributes_fr.py.md](files/tests/unit/test_inpn_protected_areas_attributes_fr.py.md) |
| `tests/unit/test_inpn_protected_areas_evidence_fr.py` | Proves complete catalog/attribute/geometry identity and FID alignment, immutable compact bundle hashing, mandatory physical profile validation, and resistance to coordinated evidence forgery. | [files/tests/unit/test_inpn_protected_areas_evidence_fr.py.md](files/tests/unit/test_inpn_protected_areas_evidence_fr.py.md) |
...
| `tests/unit/test_inpn_protected_areas_geometry_fr.py` | Proves immutable SQLite byte-snapshot authority, FID/BLOB-only reads, strict GeoPackageBinary and Z/M preservation, technical geometry domains, independent hashes, and physical rebuild. | [files/tests/unit/test_inpn_protected_areas_geometry_fr.py.md](files/tests/unit/test_inpn_protected_areas_geometry_fr.py.md) |
