...
Current bounded instruction: [DOCS.CONTINUITY.1.R2.1](tickets/DOCS.CONTINUITY.1.R2.1.txt) stabilizes only the auditor subprocess tests on `recovery/docs-continuity-1-partial`, from `64787a28bd5801dcc88f8e2107cd230fe263d476`. The supplied review accepts the principal R2 auditor corrections **within its stated scope**, not the global code/documentation corpus. Auditor bytes remain unchanged. The [R2.1 receipt](../code/audit/R2_1_DIAGNOSTICS.md) separates historical Windows evidence, the supplied Linux reproduction and new corrected executions; original [R2 diagnostics](../code/audit/R2_DIAGNOSTICS.md) remain historical and untouched. R1 remains accepted as preservation/publication only. R2.1 independent review is **PENDING**. Resolve final publication and remote refs through Git. Global semantic audit remains **PARTIAL**; no continuation of the 178-file audit or main publication is authorized. After scoped recovery-branch publication, stop for independent review.
